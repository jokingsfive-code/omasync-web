...
export default function Property() {
  ...
  const getImageUrl = (image) => {
    ...
    if (String(image).startsWith("/storage")) return `${API_URL}${image}`;
    if (String(image).startsWith("storage")) return `${API_URL}/${image}`;
  ...
  const fieldClass =
    "w-full h-14 px-4 rounded-2xl border border-gray-200 bg-white text-[16px] font-bold text-gray-950 outline-none focus:ring-4 focus:ring-cyan-500/10 focus:border-cyan-500 transition";
    ...
    <div className="bg-white rounded-[30px] border border-gray-100 shadow-sm p-5 sm:p-7">
      <div className="flex items-start justify-between gap-4 mb-6">
        ...
        <button
          type="button"
          onClick={closeForm}
          className="xl:hidden w-10 h-10 rounded-full bg-slate-100 flex items-center justify-center"
        >
          <X size={18} />
        </button>
      </div>
      ...
      <form onSubmit={saveProperty} className="space-y-5">
        <div>
          ...
          <label className="block rounded-[26px] overflow-hidden cursor-pointer border-2 border-dashed border-cyan-100 hover:border-cyan-400 transition bg-gradient-to-br from-cyan-50 to-blue-50">
            {imagePreview ? (
              <div className="relative aspect-[4/3] sm:aspect-square">
                ...
                <div className="absolute inset-0 bg-black/35 opacity-0 hover:opacity-100 transition flex items-center justify-center text-white font-black">
                  Change Photo
                </div>
              </div>
            ) : (
              <div className="aspect-[4/3] sm:aspect-square flex flex-col items-center justify-center text-gray-500 p-6">
                <div className="w-16 h-16 rounded-full bg-white text-cyan-600 flex items-center justify-center mb-4 shadow-sm">
                  <ImagePlus size={34} />
                </div>
        ...
        <div>
          ...
          <div className="flex">
            <input
              ...
              placeholder="350000"
              className="w-full h-14 px-4 rounded-l-2xl border border-gray-200 bg-white text-[16px] font-bold text-gray-950 outline-none focus:ring-4 focus:ring-cyan-500/10 focus:border-cyan-500 transition"
            />

            <div className="h-14 px-5 rounded-r-2xl bg-cyan-50 border border-l-0 border-cyan-100 font-black text-cyan-700 flex items-center">
              RM
            </div>
          </div>
        </div>
        ...
        <div>
          ...
          <textarea
            ...
            rows="4"
            className="w-full px-4 py-4 rounded-2xl border border-gray-200 bg-white text-[16px] font-semibold text-gray-950 outline-none focus:ring-4 focus:ring-cyan-500/10 focus:border-cyan-500 resize-none transition"
          />
        </div>
        ...
        <div className="flex flex-col sm:flex-row gap-3 pt-2">
          <button
            type="submit"
            className="flex-1 h-14 bg-gradient-to-r from-cyan-500 to-blue-600 text-white rounded-2xl font-black hover:shadow-xl hover:shadow-cyan-500/20 active:scale-[0.98] transition"
          >
          ...
          {editId && (
            <button
              type="button"
              onClick={resetForm}
              className="h-14 px-5 rounded-2xl bg-slate-100 text-gray-900 font-black hover:bg-slate-200 transition"
            >
              Cancel
            </button>
          )}
        ...
        <div className="w-full max-w-[1600px] mx-auto">
          ...
          <div className="mb-5 sm:mb-7">
            <div className="pl-20 sm:pl-0 mb-5">
              <div className="flex items-center gap-3">
                <div className="hidden sm:flex w-11 h-11 rounded-2xl bg-gradient-to-br from-cyan-500 to-blue-600 text-white items-center justify-center shadow-lg shadow-cyan-500/20">
                  <Building2 size={22} />
                </div>
            ...
            <div className="w-full grid grid-cols-1 lg:grid-cols-[1fr_auto] gap-3">
              <div className="bg-white rounded-[24px] border border-gray-100 shadow-sm px-4 h-14 flex items-center gap-3">
                ...
                <input
                  ...
                  className="bg-transparent outline-none w-full font-bold text-[16px] text-gray-700"
                />
              </div>
              ...
              <button
                ...
                className="h-14 px-5 rounded-[24px] bg-gradient-to-r from-cyan-500 to-blue-600 text-white font-black flex items-center justify-center gap-2 hover:shadow-xl hover:shadow-cyan-500/20 active:scale-[0.98] transition"
              >
                <Plus size={19} />
                Add Property
              </button>
                ...
                <>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-5 sm:gap-6">
                    {filteredProperties.map((property) => {
                      ...
                      return (
                        <div
                          key={property.id}
                          className="group bg-white rounded-[32px] shadow-sm border border-gray-100 hover:shadow-2xl hover:-translate-y-1 transition-all duration-300 overflow-hidden"
                        >
                          <div className="relative aspect-[4/3] bg-gradient-to-br from-cyan-100 to-blue-100 overflow-hidden">
                            {propertyImage ? (
                              <img
                                src={propertyImage}
                              ...
                              <div className="w-full h-full text-cyan-500 flex items-center justify-center">
                                <Building2 size={68} />
                              </div>
                            )}
                            ...
                            <div className="absolute top-4 right-4 flex gap-2">
                              <button
                                ...
                                className="w-10 h-10 rounded-2xl bg-white/95 text-gray-950 flex items-center justify-center hover:bg-cyan-50 shadow-lg transition"
                              >
                                <Pencil size={17} />
                              </button>
                            ...
                            <div className="absolute bottom-4 left-4 right-4">
                              <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-gradient-to-r from-cyan-500 to-blue-600 text-white font-black text-xs shadow-xl shadow-cyan-500/25">
                                <Sparkles size={14} />
                                Premium Unit
                              </div>
                            </div>
                          ...
                          <div className="p-5 sm:p-6">
                            <div className="flex items-start justify-between gap-4">
                              ...
                              <div className="w-11 h-11 rounded-2xl bg-gradient-to-br from-cyan-500 to-blue-600 text-white flex items-center justify-center shrink-0 shadow-lg shadow-cyan-500/20">
                                <Building2 size={22} />
                              </div>
                            </div>

                            <div className="mt-5 rounded-[24px] bg-gradient-to-r from-cyan-500 to-blue-600 p-4 text-white shadow-xl shadow-cyan-500/20">
                              <p className="text-xs text-white/75 font-black uppercase tracking-wider">
                                Property Value
                              </p>
                  ...
                  {filteredProperties.length === 0 && (
                    <div className="bg-white rounded-[30px] shadow-sm p-10 text-center border border-gray-100">
                      <div className="w-20 h-20 mx-auto rounded-3xl bg-cyan-50 text-cyan-600 flex items-center justify-center">
                        <Building2 size={38} />
                      </div>
                  ...
                  <div className="mt-6 bg-white rounded-[30px] p-5 sm:p-6 shadow-sm border border-gray-100 flex flex-col md:flex-row md:items-center justify-between gap-5">
                    <div className="flex items-center gap-4">
                      <div className="w-14 h-14 rounded-3xl bg-cyan-50 text-cyan-600 flex items-center justify-center shrink-0">
                        <Home size={28} />
                      </div>
                    ...
                    <div className="px-6 py-3 rounded-2xl bg-gradient-to-r from-cyan-500 to-blue-600 text-white font-black text-center shadow-xl shadow-cyan-500/20">

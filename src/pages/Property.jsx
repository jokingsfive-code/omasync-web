...
export default function Property() {
  ...
  return (
    <div
      className="p-8 min-h-screen relative overflow-hidden"
      style={{
        background:
    ...
    >
      ...
      <div className="absolute top-8 right-[260px] w-40 h-40 rounded-full border-[30px] border-blue-100/50 pointer-events-none" />
      ...
      <div className="relative z-10 mb-10 flex flex-col xl:flex-row xl:items-center xl:justify-between gap-6">
        <div className="flex items-center gap-5">
          <div className="w-16 h-16 rounded-3xl bg-[#0D3B66]/10 text-[#0D3B66] flex items-center justify-center shadow-sm">
            <Building2 size={32} />
          </div>

          <div>
            <h1 className="text-5xl font-black tracking-tight text-[#0D3B66]">
              Properties
            </h1>
        ...
        <div className="bg-white/75 backdrop-blur-xl border border-white/70 shadow-xl rounded-3xl px-5 py-4 flex items-center gap-3 min-w-[360px]">
      ...
      <div className="relative z-10 grid grid-cols-1 xl:grid-cols-12 gap-8">
        <div className="xl:col-span-4">
          <div className="bg-white/85 backdrop-blur-xl rounded-[32px] shadow-2xl p-7 border border-white/70 sticky top-8">
            <div className="flex items-center gap-4 mb-7">
              <div className="w-13 h-13 rounded-3xl bg-gradient-to-br from-[#0D3B66] to-blue-600 text-white flex items-center justify-center shadow-lg shadow-blue-900/20">
                <Plus size={24} />
              </div>
            ...
            <form onSubmit={saveProperty} className="space-y-5">
              <div>
                ...
                <label className="block rounded-[28px] overflow-hidden cursor-pointer border-2 border-dashed border-blue-300 hover:border-[#0D3B66] transition bg-gradient-to-br from-white to-blue-50/40">
                  {imagePreview ? (
                    ...
                    <div className="aspect-square flex flex-col items-center justify-center text-gray-500 p-8">
        ...
        <div className="xl:col-span-8">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-7">
            {filteredProperties.map((property) => (
              <div
                key={property.id}
                className="group bg-white/90 backdrop-blur-xl rounded-[34px] shadow-xl border border-white/70 hover:shadow-2xl hover:-translate-y-1 transition-all duration-300 overflow-hidden"
              >
                <div className="relative aspect-square bg-[#0D3B66]/10 overflow-hidden">
                  ...
                  <div className="absolute top-5 right-5 flex gap-2">
                    <button
                      ...
                      className="w-11 h-11 rounded-2xl bg-white/90 text-[#0D3B66] flex items-center justify-center hover:bg-blue-50 shadow-lg transition"
                    >
                      <Pencil size={18} />
                    </button>
                    ...
                    <button
                      ...
                      className="w-11 h-11 rounded-2xl bg-white/90 text-red-500 flex items-center justify-center hover:bg-red-50 shadow-lg transition"
                    >
                      <Trash2 size={18} />
                    </button>
                  </div>
                ...
                <div className="p-7">
                  <div className="flex items-start justify-between gap-4">
                    ...
                    <div className="w-13 h-13 rounded-3xl bg-[#0D3B66]/10 text-[#0D3B66] flex items-center justify-center shrink-0">
                      <Building2 size={25} />
                    </div>
                  </div>

                  <div className="mt-6 rounded-3xl bg-gradient-to-br from-blue-50 to-white border border-blue-100 p-5">
                    <p className="text-sm text-gray-500 font-semibold">
                      Property Value
                    </p>

                    <p className="text-3xl font-black text-[#0D3B66] mt-1">
                      RM {Number(property.price || 0).toLocaleString()}
                    </p>
                  </div>

                  <p className="mt-5 text-gray-600 text-sm leading-relaxed line-clamp-3 min-h-[64px]">
          ...
          {filteredProperties.length === 0 && (
            <div className="bg-white/90 backdrop-blur-xl rounded-[32px] shadow-xl p-12 text-center border border-white/70">
          ...
          <div className="mt-8 bg-gradient-to-r from-white/85 to-blue-50/80 backdrop-blur-xl rounded-[32px] p-7 shadow-xl border border-white/70 flex flex-col md:flex-row md:items-center justify-between gap-5">
            <div className="flex items-center gap-4">
              <div className="w-16 h-16 rounded-3xl bg-blue-100 text-[#0D3B66] flex items-center justify-center">
                <Home size={32} />
              </div>
            ...
            <div className="px-5 py-3 rounded-2xl bg-[#0D3B66] text-white font-bold">

...
const channelColors = {
  airbnb: { main: "bg-rose-500 border-rose-600 text-white", dot: "bg-rose-500" },
  booking: { main: "bg-blue-600 border-blue-700 text-white", dot: "bg-blue-600" },
  agoda: { main: "bg-purple-600 border-purple-700 text-white", dot: "bg-purple-600" },
  direct: { main: "bg-emerald-600 border-emerald-700 text-white", dot: "bg-emerald-600" },
  website: { main: "bg-amber-500 border-amber-600 text-white", dot: "bg-amber-500" },
  other: { main: "bg-slate-600 border-slate-700 text-white", dot: "bg-slate-600" },
};

...
export default function Reservations() {
  ...
  return (
    ...
    >
      ...
      <div className="mb-8">
        <h1 className="text-4xl font-bold text-[#0D3B66]">Reservations</h1>
      ...
      {viewMode !== "list" && (
        <div className="bg-white/90 backdrop-blur-xl rounded-3xl shadow-xl p-6 mb-8 border border-white/70">
        ...
        <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-5 mb-7">
          ...
          <div className="flex flex-col md:flex-row gap-3">
            <input
              ...
              className="px-5 py-3 rounded-2xl border border-gray-200 bg-white shadow-sm min-w-[280px] focus:outline-none focus:ring-2 focus:ring-[#0D3B66]"
            />
        ...
        {filteredReservations.length === 0 ? (
          ...
          <div className="space-y-4">
            {filteredReservations.map((reservation) => (
              ...
              >
                <div className="grid grid-cols-1 xl:grid-cols-9 gap-5 items-center">
